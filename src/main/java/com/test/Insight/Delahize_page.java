...
public class Delahize_page {
	...
	public static void setup() throws Exception {
		...
		caps.setCapability("app", "D:\\EclipseWorkspace\\Insight\\ApkFile\\DCInsights v7.1.5.apk");
		//caps.setCapability("app", "D:\\EclipseWorkspace\\Insight\\ApkFile\\DCInsightsV6-release-6.1.39.apk");
...
//	    elementsOne.
	...
	public static void LocationsScreen(int index) {
		...
		// ("//android.view.View[1]/android.widget.FrameLayout[2]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.ListView[1]/android.widget.LinearLayout[1]/android.widget.LinearLayout["
		// + index + "]/android.widget.TextView[1]")).click();
		("/hierarchy/android.widget.FrameLayout/android.view.View/android.widget.FrameLayout[2]/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.LinearLayout["
				+ index + "]")).click();
	...
	public static class ContainerScreen {
		public static void supplierSelection() {
			driver.findElement(By.xpath(
					"/hierarchy/android.widget.FrameLayout/android.view.View/android.widget.FrameLayout[2]/android.widget.LinearLayout/android.widget.GridView/android.widget.LinearLayout[1]/android.widget.Button"))
					.click();
		}

		public static void firstSupplier(int index) {
			driver.findElement(By.xpath(
					"/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.ListView/android.widget.LinearLayout["
							+ index + "]/android.widget.TextView"))
					.click();
		}

		public static void pOSelection() {
			driver.findElement(By.xpath(
					"/hierarchy/android.widget.FrameLayout/android.view.View/android.widget.FrameLayout[2]/android.widget.LinearLayout/android.widget.GridView/android.widget.LinearLayout[2]/android.widget.Button"))
					.click();
		}
	...
	public static class ProductScreen {
		...
		public static void productSelection(int index) {
			...
			driver.findElement(By.xpath
			// ("/hierarchy/android.widget.FrameLayout[2]/android.widget.LinearLayout[1]/android.widget.ExpandableListView[1]/android.widget.LinearLayout["
			// + index + "]")).click();
			("/hierarchy/android.widget.FrameLayout/android.view.View/android.widget.FrameLayout[2]/android.widget.LinearLayout/android.widget.ExpandableListView/android.widget.LinearLayout/android.widget.RelativeLayout/android.widget.TextView["
					+ index + "]")).click();
		}
		...
		public static void productName(int index) {
			driver.findElement(By.xpath(
					"/hierarchy/android.widget.FrameLayout[2]/android.widget.LinearLayout[1]/android.widget.ExpandableListView[1]/android.widget.LinearLayout["
							+ index + "]/android.widget.RelativeLayout[1]/android.widget.TextView[1]"))
					.getText();
		}
		...
		public static void poSelection() {
			...
			driver.findElement(By.xpath(
					"/hierarchy/android.widget.FrameLayout[1]/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.LinearLayout[2]/android.widget.ListView[1]/android.widget.LinearLayout[2]"))
					.click();
		}

		public static void backButton() {
			driver.findElement(By.xpath(
					"/hierarchy/android.widget.FrameLayout[1]/android.view.View[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]"))
					.click();
